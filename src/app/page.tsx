  ...
  const stores_food = [
    {
      ...
      add: "スパイスカレー",
      content: `
      皆さまこんにちは！SPICE TRYです。<br>
当店は、食べログ カレー 百名店にも選出されたINDIA GATE、SPICE GATEの姉妹店として、昨年10月近鉄みやこみちにOPENいたしました。<br>
カツカレーやスパイスラーメンをメインに、その他スパイスを使用した一品料理など多数ご用意しております。<br>
<br>
今回のイベントでは、店舗でも大人気のトムヤム春巻きとパクチー餃子をご提供いたします。<br>
スパイスを感じる一味違うお料理は、ビールが進むこと間違いなしです！<br>
辛さも控えめなので、辛いものが苦手な方でも美味しくお召し上がりいただけます。<br>
ぜひ一度ご賞味ください！
      `
    },
    {
  ...
  const partner = [
    {
      ...
      add: "",
      content: `
イベント開催の2日間、「スーパー銭湯伏見力の湯」の館内で「明治ブルガリア フローズンヨーグルトデザート」を配布!<br>
<br>
※1日限定1500名様<br>
<br>
アイスの濃厚なコクとヨーグルトの爽やかさを両立した、新しいタイプのフローズンヨーグルトデザートです。<br>
<br>
デザートとしての満足感と、ヨーグルトならではの程よい酸味を活かしたさっぱり感をお楽しみいただけます。
      `
    },
    {
...
駅構内のゴミ箱はご利用いただけませんので、恐れ入りますが、ゴミは各自お持ち帰りいただきますようお願いいたします。`
  ...
  return (
    <>
      ...
      <div id="top"
        className={`fixed lg:block p-4 lg:w-1/6 z-[2] top-0 h-[700px] lg:h-full lg:translate-y-[0%] w-full left-0 transition-all duration-300 ease-in-out ${scrollY > 200 && scrollY < 1200 ? " opacity-0" : " opacity-100"} ${_isMenu ? "translate-y-[0%] bg-cl-1 lg:bg-transparent" : "translate-y-[-630px]"}`}>
